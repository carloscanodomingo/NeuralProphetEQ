...
${BINDIR}/$RUNNER CONFIG 23 1234567 --historic_lenght=29  --simulation_scenario=SR --hm=$hm--training_lenght_days=179 --learning_rate=3 --dropout=0.1 --batch_size=400 --epochs=300 --n_layers=7 --internal_size=12 --use_gpu=0 --probabilistic=1 --patience=10 offset_start=730 --verbose=0 --data_path=/mnt/hum01-home01/ambs/y06068cc/data/ --out_path=/mnt/hum01-home01/ambs/y06068cc/output/results/HM00$hm --model=TCN --TCN_dilation_base=4 --TCN_weight_norm=1 --forecast_lenght_hours=24
EOF
}
