...
@click.option(
    "--daily_seasonality", default=True, type=bool, help="Set daily seasonality"
)
@click.option(
    "--yearly_seasonality", default=True, type=bool, help="Set yearly seasonality"
)
@click.option(
    "--seasonal_reg",
    default=0,
    type=float,
    help="Set regularization coefficient for seasonality",
)
@click.option(
    "--multivariate_season",
    default=True,
    type=bool,
    help="Set Multivariate seasonality",
)
@click.option(
    "--multivariate_trend", default=True, type=bool, help="Set Multivariate trend"
)
@click.option(
    "--event_mode",
...
@click.option(
    "--trend_regularization", default=True, type=bool, help="Trend regularization"
)
@click.option(
    "--trend_n_changepoint", default=10, type=int, help="Number of Changepoit"
)
...
def configure(
    ...
    NPw_o = NPw(
        config_npw, df_regressor, df_other, config_events, df_events, synthetic_events
    )
