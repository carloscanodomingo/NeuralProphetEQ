...
${BINDIR}/$RUNNER --data_path=/mnt/hum01-home01/ambs/y06068cc/data/ --out_path=/mnt/hum01-home01/ambs/y06068cc/output/results/ --forecast_type=iteration --total_index=150  --historic_lenght=15 --training_lenght_days=365 --learning_rate=2 --dropout=0.4 --batch_size=600 --n_epochs=300 --patience=20 --dilation_base=2 --weight_norm=1 --kernel_size=32 --num_filter=6 --verbose=0  --current_index=\$((\$SGE_TASK_ID - 1))
EOF
}
